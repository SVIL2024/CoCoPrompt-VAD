...
def train(cfg: DictConfig) -> Tuple[dict[str, Any], dict[str, Any]]:
    ...
    #     cfg.trainer, callbacks=callbacks, logger=logger, strategy=DDPStrategy(find_unused_parameters=False),
    # )
    trainer: Trainer = hydra.utils.instantiate(
    ...
    if cfg.get("test"):
        ...
        if checkpoint_callback is not None:
            ...
            if best_ckpt_path:
                ...
                log.info(f"Best ckpt not found. Using provided ckpt_path for testing: {ckpt_path}")
            else:
                log.warning("Best ckpt not found! Using current weights for testing...")
        else:
            if ckpt_path:
                log.info(f"Checkpointing is disabled. Using provided ckpt_path for testing: {ckpt_path}")
            else:
                log.info("Checkpointing is disabled. Using current weights for testing...")
